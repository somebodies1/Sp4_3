 ...
 */
CSceneNode::CSceneNode(TEXTURE_TYPE texture, const int snID)
	: snID(-1)
	, cParentNode(NULL)
	, worldTransformMtx(glm::mat4(1.0f))
	, worldTranslateMtx(glm::mat4(1.0f))
...
bool CSceneNode::Init(void)
{
	...
	//iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/Vehicles/SUV/dripH.tga", false);
	//if (iTextureID == 0)
	//{
	//	cout << "Unable to load Models/Vehicles/SUV/dripH.tga" << endl;
	//	return false;
	//}
	if (SetTexture(textType) == false)
	{
		cout << "Unable to load Default SceneNode Texture" << endl;
		return false;
	}
...
bool CSceneNode::SetTexture(TEXTURE_TYPE newTexture)
{
	switch (newTexture)
	{
	case DEFAULT:
		// load and create a texture 
		this->iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/UVMap.jpg", false);
	...
	case DRIP:
		// load and create a texture 
		this->iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/Vehicles/SUV/dripH.jpg", false);
		cout << "Loaded DRIP" << endl;
		if (iTextureID == 0)
		{
			cout << "Unable to load Models/Vehicles/SUV/dripH.jpg" << endl;
			return false;
		}
		else
			return true;
	...
	case AMONGUS:
		// load and create a texture 
		this->iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/amongus.png", false);
		cout << "Loaded DRIP" << endl;
		if (iTextureID == 0)
		{
			cout << "Unable to load Image/amongus.png" << endl;
			return false;
		}
		else
			return true;
	...
	case SUPREME:
		// load and create a texture 
		this->iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/supreme.jpg", false);
		cout << "Loaded SUPREME" << endl;
		if (iTextureID == 0)
		{
			cout << "Unable to load Image/supreme.jpg" << endl;
			return false;
		}
		else
			return true;
	...
	case LV:
		// load and create a texture 
		this->iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/lv.jpg", false);
		cout << "Loaded LV" << endl;
		if (iTextureID == 0)
		{
			cout << "Unable to load Image/lv.jpg" << endl;
			return false;
		}
		else
			return true;
	...
	case GUCCI:
		// load and create a texture 
		this->iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/gucci.jpg", false);
		cout << "Loaded GUCCI" << endl;
		if (iTextureID == 0)
		{
			cout << "Unable to load Image/gucci.jpg" << endl;
			return false;
		}
		else
			return true;
	...
	case BANANA:
		// load and create a texture 
		this->iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/banana.jpg", false);
		cout << "Loaded BANANA" << endl;
		if (iTextureID == 0)
		{
			cout << "Unable to load Image/banana.jpg" << endl;
			return false;
		}
		else
			return true;
	...
	default:
		// load and create a texture 
		this->iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/Models/UVMap.jpg", false);
		if (iTextureID == 0)
		{
			cout << "Unable to load Models/Models/UVMap.jpg" << endl;
			return false;
		}
		else
			return true;
