 ...
 */
WatchTower::WatchTower(const glm::vec3 vec3Position,
...
bool WatchTower::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/WatchTower/WatchTower.obj",
			"Models/WatchTower/WatchTowerTex.jpg",
 ...
 */
bool WatchTower::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void WatchTower::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void WatchTower::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void WatchTower::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool WatchTower::Update(const double dElapsedTime)
{
 ...
 */
void WatchTower::PreRender(void)
{
...
*/
void WatchTower::PostRender(void)
{
...
/**
 @brief Print Self
 */
void WatchTower::PrintSelf(void)
{
	cout << "WatchTower::PrintSelf()" << endl;
	cout << "========================" << endl;
}
