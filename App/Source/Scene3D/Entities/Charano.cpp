 ...
 */
Charano::Charano(	const glm::vec3 vec3Position,
...
bool Charano::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/Dinosaur/charo.obj", 
								"Models/Dinosaur/charoH.png",
 ...
 */
bool Charano::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void Charano::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void Charano::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void Charano::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool Charano::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void Charano::PrintSelf(void)
{
	cout << "Charano::PrintSelf()" << endl;
	cout << "========================" << endl;
}
