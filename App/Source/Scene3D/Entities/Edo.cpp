 ...
 */
Edo::Edo(	const glm::vec3 vec3Position,
...
bool Edo::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/Dinosaur/edo.obj", 
								"Models/Dinosaur/edoH.png",
 ...
 */
bool Edo::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void Edo::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void Edo::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void Edo::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool Edo::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void Edo::PrintSelf(void)
{
	cout << "Edo::PrintSelf()" << endl;
	cout << "========================" << endl;
}
