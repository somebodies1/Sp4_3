 ...
 */
Baryonyx::Baryonyx(	const glm::vec3 vec3Position,
...
bool Baryonyx::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/Dinosaur/baryonyx.obj", 
								"Models/Dinosaur/baryonyxH.png",
 ...
 */
bool Baryonyx::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void Baryonyx::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void Baryonyx::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void Baryonyx::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool Baryonyx::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void Baryonyx::PrintSelf(void)
{
	cout << "Baryonyx::PrintSelf()" << endl;
	cout << "========================" << endl;
}
