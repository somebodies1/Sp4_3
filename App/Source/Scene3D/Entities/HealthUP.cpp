...
bool CHealthUP::Init(void)
{
	...
	// Set the type
	SetType(CEntity3D::TYPE::HEALTH_UP);
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/HealthUp.jpg", false);
	if (iTextureID == 0)
	{
		cout << "Unable to load Image/HealthUp.jpg" << endl;
		return false;
	}
