 ...
 */
SUV::SUV(	const glm::vec3 vec3Position,
...
bool SUV::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/Vehicles/SUV/suv.obj", 
								"Models/Vehicles/SUV/dripH.jpg",
 ...
 */
bool SUV::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void SUV::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void SUV::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void SUV::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool SUV::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void SUV::PrintSelf(void)
{
	cout << "SUV::PrintSelf()" << endl;
	cout << "========================" << endl;
}
