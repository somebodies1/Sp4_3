...
class Soldier : public CSolidObject, public CFSM
{
public:
	// Defines several possible options for camera movement. Used as abstraction to stay away from window-system specific input methods
	enum class SOLDIERMOVEMENT : unsigned int
	{
		FORWARD = 0,
		BACKWARD,
		LEFT,
	...
	Soldier(const glm::vec3 vec3Position,
	...
	void ProcessMovement(const SOLDIERMOVEMENT direction, const float fDeltaTime);
