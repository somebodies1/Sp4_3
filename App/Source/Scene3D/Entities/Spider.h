...
class Spider : public CSolidObject, public CFSM
{
public:
	// Defines several possible options for camera movement. Used as abstraction to stay away from window-system specific input methods
	enum class SPIDERMOVEMENT : unsigned int
	{
		FORWARD = 0,
		BACKWARD,
		LEFT,
	...
	Spider(const glm::vec3 vec3Position,
	...
	void ProcessMovement(const SPIDERMOVEMENT direction, const float fDeltaTime);
