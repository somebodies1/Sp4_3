 ...
 */
Dinosaur::Dinosaur(	const glm::vec3 vec3Position,
...
bool Dinosaur::Init(void)
{
	...
	{
		if (LoadModelAndTexture("Models/Dinosaur/dinosaur.obj", 
								"Models/Dinosaur/dinosaurH.png",
 ...
 */
bool Dinosaur::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void Dinosaur::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void Dinosaur::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void Dinosaur::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool Dinosaur::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void Dinosaur::PrintSelf(void)
{
	cout << "Dinosaur::PrintSelf()" << endl;
	cout << "========================" << endl;
}
