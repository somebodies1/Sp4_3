...
class Boss : public CSolidObject, public CFSM
{
public:
	// Defines several possible options for camera movement. Used as abstraction to stay away from window-system specific input methods
	enum class BOSSMOVEMENT : unsigned int
	{
		FORWARD = 0,
		BACKWARD,
		LEFT,
	...
	Boss(const glm::vec3 vec3Position,
	...
	void ProcessMovement(const BOSSMOVEMENT direction, const float fDeltaTime);
