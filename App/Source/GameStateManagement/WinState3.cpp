...
bool CWinState3::Init(void)
{
	...
	background = new CBackgroundEntity("Image/GUI/winscreen3.tga");
...
bool CWinState3::Update(const double dElapsedTime)
{
	...
	if (CKeyboardController::GetInstance()->IsKeyReleased(GLFW_KEY_SPACE))
	{
		...
		CGameStateManager::GetInstance()->SetActiveGameState("WinState4");
		return true;
	}
